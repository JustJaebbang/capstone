...
class FinalSummarySchema(BaseModel):
    ...
    element_scores: List[ElementScoreItem]
...
LLMResultItem.model_rebuild()
LLMResponseSchema.model_rebuild()
TopOpinionItem.model_rebuild()
ElementScoreItem.model_rebuild()
OpinionGroupItem.model_rebuild()
OpinionGroupReviewsResponse.model_rebuild()
SentimentRatioSchema.model_rebuild()
FinalSummarySchema.model_rebuild()
FinalResultSchema.model_rebuild()
OpinionGroupListItem.model_rebuild()
OpinionGroupListResponse.model_rebuild()
CollectionRunRequest.model_rebuild()
CollectionJobResponse.model_rebuild()
SubscribeRequest.model_rebuild()
SubscribeResponse.model_rebuild()
CollectedReview.model_rebuild()
DashboardMoviesResponse.model_rebuild()
